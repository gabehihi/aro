...
@pytest.mark.asyncio
async def test_classify_preview(client: AsyncClient) -> None:
    """POST /screening/classify-preview — auth 없이 결과 반환."""
...
@pytest.mark.asyncio
async def test_save_screening_patient_not_found(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_dashboard_returns_structure(client: AsyncClient) -> None:
